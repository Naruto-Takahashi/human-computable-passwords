#!/usr/bin/env bash
# =============================================================================
# 段階5: 動的参照の「参照範囲」ラダー — 壁の位置を刻む
#
# 【なぜこれをやるのか】
# 段階3（構造ラダー）と段階4（学習量スイープ）で，動的参照を1本→2本
...
# 段階3の結果をそのまま端点として使う： ks1 = 13.0%, ks2 = 16.0%（各500件）。
#
...
#   学習条件は段階3・4と完全に同一（pure / stage2 / n_train=1000 / epochs=5）
...
echo "=== [$(date '+%m/%d %H:%M:%S')] 段階5 参照範囲ラダー 完了 ===" >> "$LOGDIR/range_ladder_done.log"
