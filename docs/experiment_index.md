...
| 5 | **壁は加算の項数である** | 静的な加算で4項=100%・5項=11.8%・6項=10.4%（実験9 段階3） |
...
| | 主張 | 足りないもの |
|---|---|---|
| 6 | 崖は4項と5項の間にある | 各1run。項数3（静的・鍵4マス）も未測定 |
...
| **9** | 09/19〜09/21 | 課題を極小にしても動的参照は学習されないか／壁は何か | 動的参照は学習された。**壁は加算の項数**で，静的でも4項と5項の間に崖がある | 段階3まで完了 |
