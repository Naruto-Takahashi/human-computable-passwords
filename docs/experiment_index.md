...
| **10** | 09/20〜 | 動的参照は難しさに寄与するのか（場合の数を揃えた比較） | — | **設計完了・未実施** |
...
| 結果 | 言えること |
|---|---|
| 両方とも約3,000で成功 | 動的参照はこの規模まで寄与しない。鍵10マスの失敗は規模の効果 |
| **動的だけ失敗** | **動的参照は難しさに寄与する。**(b) が復活し弱い形で元の主張が戻る |
| 両方とも失敗 | 効いているのは規模。崩壊点は 740 と 3,000 の間 |
