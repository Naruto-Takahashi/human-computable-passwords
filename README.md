...
python code/scripts/run_prompting.py --provider lora --model results/models/qwen2.5_1.5b/stage1/func_31/run_XXXXXXXX_XXXXXX --generator func_31 --stage 1 --paradigm pure --n_test 100
```
